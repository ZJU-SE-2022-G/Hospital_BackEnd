...
import com.segroup.hospitalsite.service.IGuideService;
...
public class GuideController {
    ...
    public JsonResultUtil<Guide> getGuideById(Integer id){
        return new JsonResultUtil<>(1,guideService.getById(id));
    }
    ...
    @PostMapping("/create")
    public JsonResultUtil<Guide> createGuide(String title, Integer authorId, String content){
        Guide n = new Guide();
    ...
    @PostMapping("/update")
    public JsonResultUtil<Guide> updateGuide(Integer id, String title, Integer authorId, String content){
        Guide n = guideService.getById(id);
        n.setAuthorId(authorId);
        n.setTitle(title);
        n.setContent(content);
