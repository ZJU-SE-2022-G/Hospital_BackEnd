...
public class ProblemFeedbackController {
    ...
    @PostMapping("/create2")
    public  JsonResultUtil<ProblemFeedback> createProblem(Integer askerId, String problem, String problemType){
    ...
    @PostMapping("/create1")
    public JsonResultUtil<ProblemFeedback> createProblem(Integer askerId, String problem){
        ProblemFeedback p = new ProblemFeedback();
        p.setProblem(problem);
        p.setAskerId(askerId);
        problemFeedbackService.save(p);
    ...
    @PostMapping("/answer")
    public JsonResultUtil<ProblemFeedback> answerProblem(Long id, Integer respondentID, String answer){
